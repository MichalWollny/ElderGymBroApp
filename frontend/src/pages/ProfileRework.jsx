  ...
  return (
    <div className="min-h-svh text-gray-200 bg-gray-950">
        ...
        <div className='flex flex-row justify-center'>
          ...
          <div className="my-8 flex flex-col justify-center">
            ...
            <div className="avatar">
              <div className="ring-primary ring-4 ring-white ring-offset-sky-300 mx-auto w-32 rounded-full ring-offset-2">
        ...
        <div className='flex flex-wrap justify-center'>
          ...
          {/* total workouts tile */}
          <div className='flex flex-wrap justify-center'>
            <div className="card w-80 glass lg:card-side rounded-lg p-6 m-2 bg-gray-900 shadow-xl cursor-pointer transition-transform hover:scale-110">
              <div className="flex flex-col justify-center items-center">
              <svg width="50" height="50" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M44.377 0.1875L3.8957 38.404C3.64623 38.7441 3.52535 39.1616 3.55453 39.5823C3.5837 40.0031 3.76105 40.3998 4.05508 40.7022C4.33024 40.9827 4.69427 41.1589 5.08495 41.2008C5.47564 41.2427 5.86874 41.1476 6.19708 40.9317L44.377 0.1875Z" fill="#702848"/>
                  <path d="M40.5508 12.2891L9.17622 41.3909C8.92675 41.731 8.80587 42.1485 8.83504 42.5692C8.86422 42.99 9.04157 43.3868 9.33559 43.6891C9.61075 43.9696 9.97478 44.1459 10.3655 44.1877C10.7562 44.2296 11.1493 44.1345 11.4776 43.9186L40.5508 12.2891Z" fill="#702848"/>
                  <path d="M32.3633 3.78809L0.98394 32.89C0.734467 33.23 0.613583 33.6475 0.642761 34.0682C0.671938 34.489 0.849287 34.8858 1.14331 35.1881C1.41847 35.4686 1.7825 35.6449 2.17319 35.6867C2.56388 35.7286 2.95698 35.6335 3.28531 35.4177L32.3633 3.78809Z" fill="#702848"/>
                  <path d="M37.2607 22.5176L15.3403 42.8506C15.1657 43.0877 15.0806 43.3789 15.1001 43.6726C15.1197 43.9664 15.2426 44.2437 15.4471 44.4555C15.6394 44.6515 15.8938 44.7745 16.1668 44.8036C16.4398 44.8326 16.7144 44.7659 16.9436 44.6149L37.2607 22.5176Z" fill="#702848"/>
                  <path d="M22.874 6.58789L0.955182 26.9194C0.780553 27.1564 0.695474 27.4476 0.715018 27.7413C0.734565 28.0351 0.857471 28.3125 1.06196 28.5243C1.25427 28.7202 1.50867 28.8432 1.78165 28.8723C2.05464 28.9013 2.32924 28.8347 2.55849 28.6836L22.874 6.58789Z" fill="#702848"/>
                  <path d="M32.5166 32.9658L22.5525 42.1809C22.4687 42.2995 22.428 42.4431 22.437 42.588C22.446 42.7329 22.5041 42.8704 22.6019 42.9778C22.6891 43.0741 22.8084 43.1353 22.9375 43.15C23.0666 43.1647 23.1966 43.1318 23.3031 43.0574L32.5166 32.969V32.9658Z" fill="#702848"/>
                  <path d="M12.7773 11.6748L2.81322 20.8899C2.72949 21.0085 2.68874 21.1521 2.69773 21.297C2.70671 21.4419 2.76489 21.5794 2.86263 21.6867C2.94981 21.7831 3.06912 21.8443 3.19821 21.859C3.3273 21.8736 3.45731 21.8407 3.56388 21.7664L12.7773 11.6748Z" fill="#702848"/>
                </svg>
              </div>
              <div className="card-body">
              <div className='flex flex-col items-center'>
                <h2 className="card-title font-semibold py-2">My total workouts</h2>
