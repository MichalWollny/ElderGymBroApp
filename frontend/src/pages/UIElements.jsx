  ...
  return (
    ...
    <div className="min-h-svh text-gray-200 bg-gray-950">
      ...
      <div className="flex flex-row justify-center">
        <h1 className="bg-gradient-to-br from-white to-gray-400 bg-clip-text p-2 text-center font-cthulhumbus font-medium leading-tight text-transparent sm:text-3xl md:text-4xl">-- UI Elements Library --</h1>
      </div>
        ...
        <div className='grid grid-cols-3 grid-flow-row auto-rows-max bg-green-900'>
          <br/>
          <div className="">
          ...
          <div className="">
            ...
            <input class="styled" type="button" value="| I'm a button |" />
            <br/>
          </div>
          ...
          <div className="">
            ...
            <label for="tentacles">Number of tentacles (1-10):</label>
          ...
          <div className="flex flex-row justify-center bg-purple-900">
            {/* Button */}
            <button className="rounded-full border border-white bg-pink-900 px-4 py-2 text-white transition-transform hover:scale-110">Button
              <a href="/uielements">
              Next
              </a>
            </button>
