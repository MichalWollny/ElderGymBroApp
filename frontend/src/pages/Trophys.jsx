...
const Trophys = ({ progress, updateProgress, toggleAchievement, unlockedAchievments }) => {
  ...
  return (
    <div className="min-h-svh bg-gradient-to-br from-black to-blue-950 pb-20 pt-20 md:pb-0">
      {/* window bar */}
      ...
      <div className="mb-4 flex justify-center">
        <svg
          ...
          <g id="SVGRepo_iconCarrier">
            <rect x="11.9141" y="15.4102" width="1.58679" height="5.59554" fill="url(#paint0_linear_103_1804)"></rect>
            ...
            <defs>
              <linearGradient
                ...
                <stop stopColor="#C07F00"></stop>
                <stop offset="1" stopColor="#DE9300"></stop>
              </linearGradient>
              <linearGradient
      ...
      {/* Progress Bar */}
      <div className="container mx-auto mb-4 flex flex-col items-center">
      ...
      {/* Achievements Grid */}
      <div className="container mx-auto grid grid-cols-2 gap-4 px-4 md:grid-cols-3 lg:grid-cols-4">
      ...
      <Modal open={modalOpen} onClose={handleClose} className="flex items-center justify-center">
        <Box
          sx={{
            px: 4,
            py: 2,
