  ...
  return (
    ...
    <div className="min-h-svh text-gray-200 bg-gray-950">
      ...
      <div className="flex flex-row justify-center">
        <h1 className="bg-gradient-to-br from-white to-gray-400 bg-clip-text p-2 text-center font-cthulhumbus font-medium leading-tight text-transparent sm:text-3xl md:text-4xl">-- 2. Fill in window name --</h1>
      </div>
        ...
        <div className='flex flex-wrap justify-center bg-yellow-900'>
          ...
          <div className='flex flex-wrap justify-center'>
            ...
            <div className="flex flex-col min-w-36 justify-center items-center">
              ...
              <div className="card-body">
                ...
                <h2 className="card-title font-semibold py-2">Dummy Card 1</h2>
          ...
          <div className='flex flex-wrap justify-center'>
            ...
            <div className="flex flex-col min-w-36 justify-center items-center">
              ...
              <div className="card-body">
                <div className='flex flex-col items-center'>
                <h2 className="card-title font-semibold py-2">Dummy Card 2</h2>
                <p className="font-thin py-1">Subheading</p>
                  {/* <div className="card-actions justify-end">
                    <button className="btn btn-primary">Listen</button>
                  </div> */}
